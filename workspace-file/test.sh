...
选项:\
 ...
 -a, --avatar URL  指定头像 URL（可选，默认使用 DiceBear 自动生成）\
 -h, --help 显示此帮助信息\
\
常用时区参考:\
...
\
 # 指定时区 + 自定义头像\
 $0 Claw Alice Asia/Tokyo --avatar "https://example.com/avatar.png"\
\
 # 选项模式（顺序无关）\
 $0 --bot Claw --user Alice --timezone Asia/Shanghai --avatar "https://xxx.com/me.jpg"\
\
 # 通过环境变量设置头像（可写入 ~/.bashrc）\
 export AVATAR_URL="https://xxx.com/my-bot.png"\
 $0\
\
EOF\
}\
...
\
 ...
 # 👇 头像 URL 默认值：使用 DiceBear API，seed 用 BOT_NAME 保证唯一性\
